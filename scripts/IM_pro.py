...
def I_pro():
    ...
    try:
        ...
        for i in range(1,num_labels):
            ...
            if(500<=area<=500000):
                ...
                if(len(contours)>0 and (contours[0]>=5)):
        ...
        if len(m_red)>0:
            ...
            x_min = x_m_red - math.cos(m_red[0].theta_)*m_red[0].a*extension;
            x_max = x_m_red + math.cos(m_red[0].theta_)*m_red[0].a*extension;
            y_min = y_m_red - math.sin(m_red[0].theta_)*m_red[0].a*extension;
            y_max = y_m_red + math.sin(m_red[0].theta_)*m_red[0].a*extension;
    ...
    try:
        ...
        if len(m_green)>0:
            ...
            x_min = x_m_green - math.cos(m_green[0].theta_)*m_green[0].a*extension;
            x_max = x_m_green + math.cos(m_green[0].theta_)*m_green[0].a*extension;
            y_min = y_m_green - math.sin(m_green[0].theta_)*m_green[0].a*extension;
            y_max = y_m_green + math.sin(m_green[0].theta_)*m_green[0].a*extension;
            cv2.line(img_display,int(x_min),int(y_min), int(x_max), int(y_max),(0,0,0),lineWidth);
    except:
    ...
    try:
        ...
        if len(m_blue)>0:
            ...
            x_min = x_m_blue - math.cos(m_blue[0].theta_)*m_blue[0].a*extension;
            x_max = x_m_blue + math.cos(m_blue[0].theta_)*m_blue[0].a*extension;
            y_min = y_m_blue - math.sin(m_blue[0].theta_)*m_blue[0].a*extension;
            y_max = y_m_blue + math.sin(m_blue[0].theta_)*m_blue[0].a*extension;
            cv2.line(img_display,int(x_min),int(y_min), int(x_max), int(y_max),(0,0,0),lineWidth);
